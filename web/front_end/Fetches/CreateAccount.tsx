...
export const createAccount = async (user: IUser) => {
  ...
  try {
    await fetch('process.env.REACT_APP_BASE_URL/auth/create_account', options)
      .then(r => r.json())
      .then(data => {
        console.log(data);
        ...
        store.authStore.setInfoModalMsg(
          'Your account was created successfully!  Please login to proceed.',
        );
